...
public class Rook extends ChessPiece{
    ...
    public Rook(Color boja, String pozicija) throws IllegalChessMoveException{
        super(boja,pozicija);
        if(!provjeriPoziciju(pozicija)) throw new IllegalChessMoveException("Ileglana pozicija");
    }
    @Override
