...
public class Knight extends Chesspiece{
    ...
    public Knight(Color boja, String pozicija) throws IllegalChessMoveException{
        super(boja,pozicija);
    ...
    public void move(String position) throws IllegalChessMoveException{
        ...
        if(((slovo == slovo_p + 2 || slovo == slovo_p - 2) && (broj == broj_p + 1 || broj == broj_p - 1)) ||
                ((slovo == slovo_p + 1 || slovo == slovo_p - 1) && (broj == broj_p + 2 || broj == broj_p - 2))){
            pozicija = position;
        }
        else {
            throw new IllegalChessMoveException("Ilegalan potez");
